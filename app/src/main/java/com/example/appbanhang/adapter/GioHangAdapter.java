                ...
                .subscribe(
                        loaiSpModel  -> {
                            if (loaiSpModel.isSuccess()){
                                int sltk =loaiSpModel.getResult().get(0).getSoluong();
                                soluong_tk = sltk;
                                Utils.kttk = sltk;
                                Log.e("Kiem tra so luong lay ve: ", String.valueOf(soluong_tk));
                            } else{
            ...
            public void onImageClick(View view, int pos, int giatri) {
                ...
                if (giatri == 1){
                    ...
                    if(gioHangList.get(pos).getGh_soluong() < 11){
                        int soluongmoi = gioHangList.get(pos).getGh_soluong()+1;
                        Log.e("Kieem tra sl tk: ", String.valueOf(Utils.kttk));
                        if (Utils.kttk - soluongmoi >= 0){
                            gioHangList.get(pos).setGh_soluong(soluongmoi);
                            UpdateDatabase(idkh, gioHangList.get(pos).getSp_id(), soluongmoi, 2);
                        }else{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view == imgtru){
                ...
                // 2 cong
                KiemTrasltk(gioHangList.get(getAdapterPosition()).getSp_id());
